...
CREATE TABLE `t_setmeal` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='����ײ�';

/*Data for the table `t_setmeal` */

insert  into `t_setmeal`(`id`,`name`,`code`,`helpCode`,`sex`,`age`,`price`,`remark`,`attention`,`img`) values 
(4,'02','02','202','0','020',202,'020','0222','873f50f2-9137-4450-aa8a-bcb4f2753f264.jpg'),
(3,'22','222','22','0','222',222,'222','222','196aa91e-6d49-48a3-9b63-c2437bfb5fe3p.jpg'),
(5,'54645','76545','456','0','456',4646,NULL,NULL,NULL),
(6,'45656','644','456456','0','456456',46456,'45645','46','2ee480a9-ac28-44a6-9c9b-69b727bc77fb4.jpg'),
(7,'5464564','45645654','4564564','1','54645645',645645,'64','4645654','129f88f7-4c1b-4867-bbea-7bb4ed8224367.jpg'),
(8,'42343','4234','32423432','0','23432432',4234230,'23423','42423','aac29d84-0e99-4ef5-8138-2ed47c998d4f4.jpg');
